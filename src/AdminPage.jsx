                ...
                <div className="max-h-[80vh] overflow-y-auto p-2">
                    ...
                    {chartsConfig.map((chart, index) => {
                        ...
                        case 'lowStock':
                            ...
                            break;
                        case 'category':
                            chartContent = <BarChart data={dashboardData.categoriaDistribution} margin={{ top: 5, right: 30, left: 20, bottom: 5 }}>
                                <CartesianGrid strokeDasharray="3 3" stroke={theme === 'dark' ? "#4A5568" : "#E2E8F0"} />
                                <XAxis dataKey="name" stroke={theme === 'dark' ? "#A0AEC0" : "#4A5568"} tick={{ fontSize: 12 }} />
                                <YAxis stroke={theme === 'dark' ? "#A0AEC0" : "#4A5568"} allowDecimals={false} />
                                <Tooltip contentStyle={{ backgroundColor: theme === 'dark' ? '#1A202C' : '#FFFFFF', border: `1px solid ${theme === 'dark' ? '#4A5568' : '#CBD5E0'}` }} labelStyle={{ color: theme === 'dark' ? '#E2E8F0' : '#1A202C' }} formatter={(value) => [value, "Quantidade"]} />
                                <Bar dataKey="value" name="Quantidade de Itens" fill="#00C49F" />
                            </BarChart>;
                            break;
                        case 'supplier':

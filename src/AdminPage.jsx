...
import { ArrowLeft, LogOut, PlusCircle, Search, Edit, DollarSign, Package, FileDown, ChevronLeft, ChevronRight, Printer, Eye, EyeOff, History, Trash2, Layers, ShoppingCart, TrendingUp, ShoppingBag, Banknote, LayoutDashboard, Users, KeyRound, ListChecks, Mail, Send, RefreshCw, Upload, Download, UserCog, Settings, Image as ImageIcon, TrendingUp as TrendingUpIcon, Sun, Moon, HelpCircle } from 'lucide-react';
                    ...
                    <div className="bg-white dark:bg-gray-900 p-6 rounded-2xl shadow-lg border-t-4 border-cyan-500 md:col-span-1 lg:col-span-1">
                        ...
                        <div className="flex flex-col gap-3">
                            {currentUser?.permissions?.viewDashboardCharts && (
                                <button onClick={() => navigate('/analise-grafica')} className={actionButtonClasses}>

...
const RelatorioVendasUsuario = ({ reportData }) => {
    if (!reportData) {
        return <p className="text-center text-gray-500 py-10">Selecione um vendedor e um período para gerar o relatório.</p>;
    }

    const { sales, user, period, totalVendido, totalVendas, totalsByPaymentMethod } = reportData;

    return (
        <div className="p-8 bg-white text-black font-sans">
            <div className="text-center mb-8">
                <h1 className="text-2xl font-bold">Relatório de Vendas por Vendedor</h1>
...
export default RelatorioVendasUsuario;
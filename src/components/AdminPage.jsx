...
import { useEstoque, PERMISSION_GROUPS, getDefaultPermissions } from './useEstoque.jsx';
        ...
        <div className="bg-gray-950 text-gray-100 min-h-screen font-sans leading-relaxed">
            ...
            <main id="admin-non-printable-area" className="container mx-auto px-4 py-8 md:py-16">
                <div className="flex flex-wrap justify-between items-center gap-4 mb-8">
                    ...
                    <div>
                        <button onClick={onNavigateToEstoque} className="inline-flex items-center gap-2 text-green-400 hover:text-green-300 transition-colors mr-4" title="Voltar ao Estoque">
                            <ArrowLeft size={20} />
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-12">
                    ...
                    <div className="bg-gray-900 p-6 rounded-2xl shadow-lg border-t-4 border-cyan-500 md:col-span-1 lg:col-span-1">
                        ...
                        <div className="flex flex-col gap-3">
                            <button onClick={onNavigateToVendas} className={actionButtonClasses}>
                                <ShoppingCart size={18} /> Acessar Página de Vendas
                            </button>

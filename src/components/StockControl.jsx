      ...
      <Modal isOpen={isAddModalOpen} onClose={handleCloseAddModal}>
        ...
        <form className="grid grid-cols-1 md:grid-cols-2 gap-x-6 gap-y-4" onSubmit={handleAddNewProduct}>
            <div className="md:col-span-2">
                <label htmlFor="add-nome" className="block text-sm font-medium text-gray-300">Nome do Produto</label>
                <input id="add-nome" name="nome" type="text" value={newProduct.nome} onChange={handleInputChange} required className="mt-1 block w-full p-3 bg-gray-800 border border-gray-700 rounded-lg focus:outline-none focus:ring-2 focus:ring-green-500" />
            </div>
            <div>
                <label htmlFor="add-categoria" className="block text-sm font-medium text-gray-300">Categoria</label>
                <input id="add-categoria" name="categoria" type="text" value={newProduct.categoria} onChange={handleInputChange} required className="mt-1 block w-full p-3 bg-gray-800 border border-gray-700 rounded-lg focus:outline-none focus:ring-2 focus:ring-green-500" />
            </div>
            <div>
                <label htmlFor="add-marca" className="block text-sm font-medium text-gray-300">Marca</label>
                <input id="add-marca" name="marca" type="text" value={newProduct.marca} onChange={handleInputChange} required className="mt-1 block w-full p-3 bg-gray-800 border border-gray-700 rounded-lg focus:outline-none focus:ring-2 focus:ring-green-500" />
            </div>
            <div>
                <label htmlFor="add-fornecedor" className="block text-sm font-medium text-gray-300">Fornecedor</label>
                <input id="add-fornecedor" name="fornecedor" type="text" value={newProduct.fornecedor} onChange={handleInputChange} required className="mt-1 block w-full p-3 bg-gray-800 border border-gray-700 rounded-lg focus:outline-none focus:ring-2 focus:ring-green-500" />
            </div>
            <div>
                <label htmlFor="add-emEstoque" className="block text-sm font-medium text-gray-300">Em Estoque</label>
                <input id="add-emEstoque" name="emEstoque" type="number" value={newProduct.emEstoque} onChange={handleInputChange} required className="mt-1 block w-full p-3 bg-gray-800 border border-gray-700 rounded-lg focus:outline-none focus:ring-2 focus:ring-green-500" />
            </div>
            <div>
                <label htmlFor="add-qtdaMinima" className="block text-sm font-medium text-gray-300">Qtda. Mínima</label>
                <input id="add-qtdaMinima" name="qtdaMinima" type="number" value={newProduct.qtdaMinima} onChange={handleInputChange} required className="mt-1 block w-full p-3 bg-gray-800 border border-gray-700 rounded-lg focus:outline-none focus:ring-2 focus:ring-green-500" />
            </div>
            <div>
                <label htmlFor="add-tempoDeGarantia" className="block text-sm font-medium text-gray-300">Garantia (dias)</label>
                <input id="add-tempoDeGarantia" name="tempoDeGarantia" type="number" value={newProduct.tempoDeGarantia} onChange={handleInputChange} placeholder="Ex: 30" className="mt-1 block w-full p-3 bg-gray-800 border border-gray-700 rounded-lg focus:outline-none focus:ring-2 focus:ring-green-500" />
            </div>
            <div className="md:col-span-2">
                <label htmlFor="add-imagem" className="block text-sm font-medium text-gray-300">Imagem</label>
                <input id="add-imagem" name="imagem" type="file" accept="image/*" onChange={handleInputChange} className="mt-1 block w-full text-sm text-gray-400 file:mr-4 file:py-2 file:px-4 file:rounded-full file:border-0 file:text-sm file:font-semibold file:bg-green-600 file:text-white hover:file:bg-green-700 cursor-pointer" />
            ...
            <div className="md:col-span-2 flex items-center p-3 bg-gray-800/50 rounded-lg">
                <label htmlFor="add-destaque" className="flex items-center gap-3 cursor-pointer text-sm font-medium text-gray-300">
                    <input id="add-destaque" name="destaque" type="checkbox" checked={newProduct.destaque} onChange={handleInputChange} className="form-checkbox h-5 w-5 text-green-500 bg-gray-800 border-gray-700 rounded focus:ring-green-500" />

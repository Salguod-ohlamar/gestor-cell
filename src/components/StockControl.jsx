...
const fallbackInitialColumns = [
  ...
  { id: 'emEstoque', label: 'Em Estoque', sortable: true, align: 'center' },
  { id: 'qtdaMinima', label: 'Qtda. Mínima', sortable: true, align: 'center' },
  { id: 'tempoDeGarantia', label: 'Garantia (dias)', sortable: true, align: 'center' },
  { id: 'preco', label: 'Preço', sortable: true, align: 'right' },
